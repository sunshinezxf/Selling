...
public class EventController {
    ...
    public ModelAndView giftApplication(@Valid EventForm form, BindingResult result){
    	ModelAndView view = new ModelAndView();
    	EventApplication eventApplication = new EventApplication(form.getDonor_name(),form.getDonor_phone(),form.getDonee_name(),form.getDonee_phone(),form.getDonee_gender(),form.getDonee_address(),form.getRelation());
    	return view;
    }
}
