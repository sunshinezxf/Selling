...
public class CommodityDaoImpl extends BaseDao implements CommodityDao {
	...
	public ResultData queryCommodity(Map<String, Object> condition) {
		ResultData result = new ResultData();
		try {
			List<Goods> list = sqlSession.selectList("selling.goods.query",
					condition);
			result.setData(list);
		} catch (Exception e) {
			logger.error(e.getMessage());
	...
	@Override
	public ResultData queryCommodityByPage(Map<String, Object> condition,
		...
		List<Goods> current = queryCommodityByPage(condition,
	...
	private List<Goods> queryCommodityByPage(Map<String, Object> condition,
			int start, int length) {
		List<Goods> result = new ArrayList<Goods>();
		try {
			result = sqlSession.selectList("selling.goods.query", condition,
