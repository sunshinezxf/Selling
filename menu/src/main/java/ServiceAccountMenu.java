...
public class ServiceAccountMenu {
	...
	//线上
    //private final static String APPID = "wx67fcdc4fa58f7578";
    //private final static String SECRET = "152db4beaa859d90ab6f48bcc088052b";
	//测试
...
//        JSONObject agent_unbind = new JSONObject();
//        agent_unbind.put("name", "解绑");
//        agent_unbind.put("type", "click");
//        agent_unbind.put("key", "unbind");
     ...
     // agent.add(agent_register);
      agent.add(agent_tuozhan);
      agent.add(agent_share);
    //  agent.add(agent_unbind);
...
//        JSONObject password_lethe = new JSONObject();
//        password_lethe.put("name", "密码找回");
//        password_lethe.put("type", "view");
//        try {
//            password_lethe.put("url", LETHE_URL);
//        } catch (Exception e) {
//            e.printStackTrace();
//        }


//        JSONArray agent_operation = new JSONArray();
//        agent_operation.add(agent_bind);
//        agent_operation.add(agent_register);
//        agent_operation.add(agent_unbind);
//        agent_operation.add(password_lethe);
//        JSONObject agent = new JSONObject();
//        agent.put("name", "代理商");
//        agent.put("sub_button", agent_operation);
...
//        JSONObject cooperation = new JSONObject();
//        cooperation.put("name", "合作入口");
//        cooperation.put("type", "view");
//        try {
//            cooperation.put("url", "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx67fcdc4fa58f7578&redirect_uri=" + URLEncoder.encode(PLACE_ORDER_URL, "utf-8") + "&response_type=code&scope=snsapi_base&state=view#wechat_redirect");
//        } catch (Exception e) {
//            e.printStackTrace();
//        }

//        JSONArray mall = new JSONArray();
//        mall.add(purchase);
////        mall.add(cooperation);
//
//        JSONObject customer = new JSONObject();
//        customer.put("name", "商城");
//        customer.put("sub_button", mall);
